...
import { Building, LogIn, Pill } from 'lucide-react';
...
export const PharmacyLoginForm: React.FC<PharmacyLoginFormProps> = ({ onLoginSuccess, onPasswordReset }) => {
  ...
  const userType = 'pharmacy' as const;
    ...
    try {
      ...
      if (data.user) {
        ...
        if (actualUserType !== userType) {
          setError('このアカウントは薬局用ではありません。薬剤師の方は薬剤師ログイン画面をご利用ください。');
          return;
        }
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="mt-4 pt-4 border-t border-gray-200 text-center">
            <p className="text-sm text-gray-600">
              薬剤師の方は
              <button
                onClick={() => window.location.href = '/pharmacist-login'}
        ...
        {!isProduction && (
          <div className="mt-6 bg-white rounded-lg shadow-md p-6">
            ...
            <button
              ...
              className="w-full flex items-center space-x-3 p-3 rounded-lg border-2 transition-all hover:shadow-md text-blue-600 bg-blue-50 border-blue-200"
            >
