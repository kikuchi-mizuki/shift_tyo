...
DROP POLICY IF EXISTS "Pharmacy users can manage their store NG pharmacists" ON store_ng_pharmacists;
...
DROP POLICY IF EXISTS "Authenticated users can manage store NG pharmacists" ON store_ng_pharmacists;
