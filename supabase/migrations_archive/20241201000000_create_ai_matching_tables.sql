...
-- RLS ポリシーの作成
DROP POLICY IF EXISTS "Users can view their own match outcomes" ON match_outcomes;
DROP POLICY IF EXISTS "Users can view their own match outcomes" ON match_outcomes;
...
DROP POLICY IF EXISTS "Users can view their own profiles" ON pharmacist_profiles;
DROP POLICY IF EXISTS "Users can view their own profiles" ON pharmacist_profiles;
CREATE POLICY "Users can view their own profiles" ON pharmacist_profiles
  FOR SELECT USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can view their own profiles" ON pharmacy_profiles;
DROP POLICY IF EXISTS "Users can view their own profiles" ON pharmacy_profiles;
CREATE POLICY "Users can view their own profiles" ON pharmacy_profiles
  FOR SELECT USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Admins can view all data" ON match_outcomes;
DROP POLICY IF EXISTS "Admins can view all data" ON match_outcomes;
...
DROP POLICY IF EXISTS "Admins can view all data" ON learning_data;
DROP POLICY IF EXISTS "Admins can view all data" ON learning_data;
...
DROP POLICY IF EXISTS "Admins can view all data" ON pharmacist_profiles;
DROP POLICY IF EXISTS "Admins can view all data" ON pharmacist_profiles;
...
DROP POLICY IF EXISTS "Admins can view all data" ON pharmacy_profiles;
DROP POLICY IF EXISTS "Admins can view all data" ON pharmacy_profiles;
...
DROP POLICY IF EXISTS "Admins can view all data" ON matching_history;
DROP POLICY IF EXISTS "Admins can view all data" ON matching_history;
