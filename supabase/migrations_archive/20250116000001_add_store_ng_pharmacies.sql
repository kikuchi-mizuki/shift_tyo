...
DROP POLICY IF EXISTS "Pharmacists can view their store NG pharmacies" ON store_ng_pharmacies;
...
DROP POLICY IF EXISTS "Pharmacists can insert their store NG pharmacies" ON store_ng_pharmacies;
...
DROP POLICY IF EXISTS "Pharmacists can update their store NG pharmacies" ON store_ng_pharmacies;
...
DROP POLICY IF EXISTS "Pharmacists can delete their store NG pharmacies" ON store_ng_pharmacies;
...
DROP POLICY IF EXISTS "Admins can manage all store NG pharmacies" ON store_ng_pharmacies;
...
DROP TRIGGER IF EXISTS update_store_ng_pharmacies_updated_at ON store_ng_pharmacies;
