-- DISABLED: Insert test data for shift_requests and shift_postings
-- This migration has been disabled to prevent automatic data insertion
-- Test data should be inserted manually when needed
